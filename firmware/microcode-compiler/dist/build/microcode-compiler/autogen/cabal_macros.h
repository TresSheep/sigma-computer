...
/* package microcode-compiler-0.1.0.0 */
#ifndef VERSION_microcode_compiler
#define VERSION_microcode_compiler "0.1.0.0"
#endif /* VERSION_microcode_compiler */
#ifndef MIN_VERSION_microcode_compiler
#define MIN_VERSION_microcode_compiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_microcode_compiler */
...
#define CURRENT_COMPONENT_ID "microcode-compiler-0.1.0.0-9tNXcoN23tx5xCXhCZPr70-microcode-compiler"
